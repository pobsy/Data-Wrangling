...
```
Also want to remove loans that were issued in 2012. These loans will only have been a few months old when the data was cut and hence will not accurately represent the loan status as they are not mature loans. 

```{r}
#lc <- subset(lc, year_issued < 2012)
```
